...
public:
	...
	static void  __stdcall   PaintTraverse(vgui::VPANEL panel, bool forceRepaint, bool allowForce);
...
private:
	...
	std::unique_ptr<VMTHook> pvguipanelHook;
	...
	typedef void(_stdcall*  PaintTraverse_t)(IPanel*, vgui::VPANEL, bool, bool);
